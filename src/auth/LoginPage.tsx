...
export default function LoginPage() {
  ...
  useEffect(() => {
    if (githubUsername)
      Cookie.set("pq_githubUsername", githubUsername, { expires: 30 });
  }, [githubUsername]);
  ...
  useEffect(() => {
    ...
    try {
      ...
      const targetRole = oauthUser.role || "contributor";
      ...
      <CardContent className="p-8">
        <div className="text-center space-y-6">
          ...
          <p className="text-gray-600 mb-6">
            Now let's connect your GitHub account to complete sign-in.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-2">
              <div
                className={`h-2 w-8 rounded-full ${currentCase === "initial" ? "bg-gray-900" : "bg-gray-300"}`}
              />
              <div
                className={`h-2 w-8 rounded-full ${currentCase === "github_oauth" ? "bg-gray-900" : "bg-gray-300"}`}
              />
            </div>
          </div>
        </div>
        ...
        <div className="max-w-md w-full space-y-8">
          <div className="text-center">
            ...
            {currentCase === "github_oauth" && (
              <p className="text-gray-600">Complete your sign-in with GitHub</p>
            )}
          </div>
